...
{
    /// <summary>
    /// This class contains meta-information about a file in a DragonDos filesystem.
    /// </summary>
    public sealed class DragonDosFileInfo : IFileInfo
    {
        /// <summary>
        /// True for files that are flagged as protected by the filesystem.
        /// </summary>
        public bool IsProtected { get; private set; }


        internal DragonDosFileInfo(string name, int size, bool isprotected)
        {
            Name = name;
            Size = size;
